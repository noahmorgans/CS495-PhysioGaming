...
model = tf.keras.models.load_model(os.path.join(MODEL_DIR, "emg_cnn_model_1.keras"))
label_encoder = joblib.load(os.path.join(ENCODER_DIR, "emg_label_encoder_1.pkl"))
norm_params = joblib.load(os.path.join(NORM_DIR, "emg_normalization_1.pkl"))
