...
df = pd.read_csv(os.path.join(SIGNAL_DIR, "emg_signals_1.csv"))
...
model.save(os.path.join(MODEL_DIR, "emg_cnn_model_1.keras"))
joblib.dump(label_encoder, os.path.join(ENCODER_DIR, "emg_label_encoder_1.pkl"))
joblib.dump({
    'mean': X_mean, 
    'std': X_std,
    'window_size': window_size,
    'overlap': overlap
}, os.path.join(NORM_DIR, "emg_normalization_1.pkl"))
