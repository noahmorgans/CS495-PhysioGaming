...
public class Jetpack : MonoBehaviour
{
    ...
    private float overheatRate = 0.25f;   // how fast it heats up
    private float coolRate = 1f;       // how fast it cools per second
    private float cooldownDelay = 3f;    // delay before cooling starts

    [SerializeField] private AudioClip refillFuelSoundClip;
    ...
    public void RefillFuel(float refuelAmt)
    {
        ...
        //{
        //    jetpackAudioSource = SoundFXManager.instance.PlaySoundClip(refillFuelSoundClip, transform, 1f);
        //}
    }
